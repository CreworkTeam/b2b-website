...
Finding the right nail artist is frustrating. People spend hours scrolling Instagram and TikTok trying to figure out pricing, style and availability from random posts and still end up booking someone who turns out to be the wrong fit.

On the other side, talented independent nail artists struggle to get discovered. They spend more time creating content to stay visible online than actually doing their work, with no reliable way to reach people who are actively looking for them.

Nail Found wanted to solve both sides of this problem by building a centralized platform where people in Tampa Bay, Florida, USA could browse, compare and connect with nail artists all in one place.

## Solution

We designed and developed a mobile-first web platform focused on one thing: making discovery fast and easy for both sides.

People looking for a nail artist can browse a visual grid of profiles, filter by location, service and price and reach out directly. Artists create their own profile, upload their portfolio and start getting discovered without needing to constantly post on social media.
...
The platform is designed for people making visual decisions on their phones. The layout puts portfolio images front and center. Filters are minimal and fast to use. Price and availability are visible before anything else because those are the first two things anyone wants to know.
